package com.pixelsface.snake.SnakeHelper;

import android.graphics.*;

import com.pixelsface.snake.*;
...
public class DrawControl {
    ...
    public void drawControl(Canvas m_Canvas, AppConstants.Control m_Control, android.graphics.Paint m_Paint, int m_ScreenWidth, int m_ScreenHeight, int m_BlockSize, AppConstants.Direction m_Direction)
    {
        ...
        if(m_Control == com.pixelsface.snake.AppConstants.Control.POV)
        {
            if(m_Direction ==  com.pixelsface.snake.AppConstants.Direction.LEFT || m_Direction == com.pixelsface.snake.AppConstants.Direction.RIGHT)
            {
