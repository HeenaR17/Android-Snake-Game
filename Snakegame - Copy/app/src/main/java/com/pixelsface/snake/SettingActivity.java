...
public class SettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundButton = (Button) findViewById(com.pixelsface.snake.R.id.soundButton);
        soundOnButton = (RadioButton) findViewById(com.pixelsface.snake.R.id.soundOnRadio);
        soundOffButton = (RadioButton) findViewById(com.pixelsface.snake.R.id.soundOffRadio);
...
//        CurrentActivity.this.startActivity(myIntent);
        ...
        myIntent.putExtra(com.pixelsface.snake.AppConstants.SOUND_KEY,isSoundEnabled);
